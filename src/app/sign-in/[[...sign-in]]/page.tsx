      ...
      <div className="relative z-10">
        <SignIn appearance={{
          elements: {
            ...
            identityPreviewText: "font-mono text-xs font-bold text-zinc-600",
            identityPreviewEditButton: "text-zinc-900 hover:text-zinc-600",
          }
        }} />
      </div>

      <div className="absolute bottom-8 font-mono text-[10px] text-zinc-300 uppercase tracking-[0.2em]">
        wake_ping_authentication_service // v0.1.0
      </div>
    </div>
  );
}
